# Modello AB-SFC - Multipli


#'*Cose da fare*:
#'*Quando dk>1 aggiornare enll amoortamentofull per il calcolo del costo il capitale inizializzato in 2,3,4*
#'*Invertire l'ordine l_required ecc...*
...
plot(GDPreal[b:T], type='l',col=1,lwd=1,main='GDP real',ylim=range(mingdp,maxgdp),ylab='')
par(new=TRUE)
